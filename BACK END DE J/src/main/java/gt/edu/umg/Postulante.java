...
public class Postulante {
    ...
    public String toString() {
        return "Postulante{" + "postulante_id="  + ", nombre=" + nombre + ", apellido=" + apellido + ", dpi=" + dpi + ", nit=" + nit + ", telefono=" + telefono + ", telefono_adicional=" + telefono_adicional + ", nacionalidad=" + nacionalidad + ", usuario_id=" + usuario_id + ", genero_id="  + ", cod_postal_id=" + cod_postal_id + '}';
    }
